...
import com.pocotopocopo.puzzlide.BitmapContainer;
import com.pocotopocopo.puzzlide.ChronometerView;
...
import com.pocotopocopo.puzzlide.GameStatus;
import com.pocotopocopo.puzzlide.Puzzle;
    ...
    private void loadSounds(){
        ...
        soundPool.setOnLoadCompleteListener(new SoundPool.OnLoadCompleteListener() {
            ...
            public void onLoadComplete(SoundPool soundPool, int sampleId, int status) {
                Log.d(TAG,"Sound loaded " + sampleId + " status: " +status);
                loadedSound= true;
                if (!startedGame){
//                    chrono.start();
                    startedGame=true;
...
//        chrono.setTime(10000);
    ...
    private void playSound(int sound, float rate){
        if (soundEnabled && loadedSound){
            soundPool.play(sound,volume,volume,1,0,rate);
        }
    }
