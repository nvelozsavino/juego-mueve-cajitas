...
public class Piece extends View {
    ...
    public Piece(Context context, float top, float left, float width, float height,boolean border) {
        ...
        this.border=border;
        if (border) {
            borderRight = new Border(Orientation.VERTICAL, left, top, height);
            borderLeft = new Border(Orientation.VERTICAL, left + width, top, height);
            borderBottom = new Border(Orientation.HORIZONTAL, left, top, width);
            borderTop = new Border(Orientation.HORIZONTAL, left, top + height, width);
        } else {
            borderLeft = new Border(Orientation.VERTICAL, left, top, height);
            borderRight = new Border(Orientation.VERTICAL, left + width, top, height);
            borderTop = new Border(Orientation.HORIZONTAL, left, top, width);
            borderBottom = new Border(Orientation.HORIZONTAL, left, top + height, width);
...
//            }
    ...
    private Border getBorder(Side side) {
        switch (side) {
            case LEFT:
                return borderLeft;
            case RIGHT:
